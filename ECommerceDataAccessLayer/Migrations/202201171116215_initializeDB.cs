    ...
    public partial class initializeDB : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Category", t => t.BaseCategoryId)
                ...
                c => new
                    {
                        ...
                        CustomerTRID = c.String(maxLength: 11),
                        RegisterDate = c.DateTime(nullable: false),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Customers", t => t.CustomerTRID)
                .Index(t => t.CustomerTRID);
                ...
                c => new
                    {
                        ...
                        Desctiption = c.String(maxLength: 200),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Orders", "CustomerTRID", "dbo.Customers");
            DropForeignKey("dbo.Products", "CategoryId", "dbo.Category");
            DropForeignKey("dbo.Category", "BaseCategoryId", "dbo.Category");
            ...
            DropIndex("dbo.Orders", new[] { "CustomerTRID" });
